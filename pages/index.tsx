  ...
  return (
    <div className="min-h-screen bg-[#fdf6e3] text-gray-900">
      ...
      <nav className="flex items-center justify-between px-8 py-4 bg-white shadow-md">
        ...
        <div className="flex items-center space-x-3 bg-gray-100 p-3 rounded-xl">
      <button className="p-2 bg-gray-200 rounded-lg hover:bg-white transition">
      ...
      <button className="p-2 bg-gray-200 rounded-lg hover:bg-white transition">
        <VideoCameraIcon className="w-4 h-4 text-black" />
      </button>
      <button className="p-2 bg-gray-200 rounded-lg hover:bg-white transition">
